    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <form action="{{ route('permissions.update', ['permission' => $permission->id]) }}" method="post" class="col-8 offset-r-4">
                            @csrf
                            @method('put')

                            <div class="form-group ">
                                <label>Permission Name</label>
                                <input type="text" class="form-control" name="permission_name" placeholder="Enter Permission Name" value="{{ old('permission_name', $permission->permission_name) }}" autofocus />
